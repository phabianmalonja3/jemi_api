...
public class PaymentController {
    ...
    public ResponseEntity<PaymentInitiationResponse> initiatePayment(
            Principal principal,
            @Valid @RequestParam PaymentInitRequestDTO paymentInitRequestDTO
        ...
        PaymentInitiationResponse response = paymentService.initiatePaymentAsync(
                currentUser,
    ...
    public ResponseEntity<Map<String, String>> paymentCallback(
        ...
        return ResponseEntity.badRequest().body(
                Map.of(
                        ...
                        "failed",
                        "message",
                        "Invalid or failed payment callback"
                )
        );
    }
    ...
    public ResponseEntity<ByteArrayResource> downloadAllPayments(
        ...
        try {
            ...
            com.jemigraph.jemigraph_backend.Entities.User user = userRepository.findByEmail(principal.getName())
            ...
            if (startDate != null && endDate != null) {
                dateRange = "_" + startDate.toString() + "_to_" + endDate.toString();
            } else if (startDate != null) {
                dateRange = "_from_" + startDate.toString();
            }
