...
public class UserController {
  ...
  public ResponseEntity<?> uploadProfileImage(
    ...
    try {
      ...
      return ResponseEntity.ok(
          Map.of("message", "Image uploaded successfully", "imageUrl", "/uploads/" + fileName));
    } catch (Exception e) {
    ...
    try {
      ...
      if (fcmToken == null || fcmToken.isEmpty()) {
        return ResponseEntity.badRequest()
            .body(ApiResponseDTO.builder().success(false).message("FCM token is required").build());
      }
  ...
  public ResponseEntity<ApiResponseDTO> deleteFcmToken(Authentication authentication) {
    ...
    try {
      ...
      return ResponseEntity.ok(
          ApiResponseDTO.builder().success(true).message("FCM token deleted successfully").build());
