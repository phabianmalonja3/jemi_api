      ...
      return   http.csrf(AbstractHttpConfigurer::disable)
              .cors(cors -> cors.configurationSource(corsConfigurationSource))
                ...
                .authorizeHttpRequests(auth->auth
                        .requestMatchers("/ws-jemigraph/**").permitAll()
                        ...
                        .requestMatchers("/ws-jemigrapher").permitAll()
                        .requestMatchers("/app-version/**").permitAll()
                        .requestMatchers("/auth/**").permitAll() // Login na Register
                        .requestMatchers("/subscription-plans/**").permitAll()
                        .requestMatchers("/subscription-plans/activate").hasRole("ADMIN")// Login na Register
                        ...
                        .requestMatchers("/auth/**", "/client/**", "/actuator/**").permitAll()
                        // Add the versioned path here to allow public access to images
                        .requestMatchers("/api/v0.1/images/**", "/images/**", "/uploads/**").permitAll()
                        .requestMatchers("/users/**").hasRole("ADMIN")
                        .requestMatchers("/subscriptions/**").permitAll()
                        .requestMatchers("/admin/**").hasRole("ADMIN")
                        .requestMatchers("/wallet/**").hasAnyRole("ADMIN", "PHOTOGRAPHER")
                        .requestMatchers(HttpMethod.GET,"/photographers/**").permitAll()
